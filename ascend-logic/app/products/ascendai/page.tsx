...
export const metadata: Metadata = {
  title: "Ascend Agent",
  description:
    "すべての社員に、もう一人のAIアシスタントを。会議に同席し、記録し、学習し、いつでも答える。あなたの業務を誰よりも深く理解するAIが、チームの一員になります。",
  keywords:
    "AIアシスタント, AI議事録, 自動議事録作成, RAGチャットボット, Google Calendar連携, ビデオ会議文字起こし, 会議自動録画, ナレッジ検索, 議事録自動化",
  openGraph: {
    title: "Ascend Agent - あなた専属のAIアシスタント",
    description:
      "すべての社員に、もう一人のAIアシスタントを。会議に同席し、記録し、学習し、いつでも答える。",
    type: "website",
  },
};
...
const abilities = [
  {
    ...
    subtitle: "Attend",
    description:
      "オンライン会議にはAIボットが自動参加。デスクトップアプリを使えば対面会議の録画にも対応。あなたの代わりに記録係を担当します。",
    icon: (
  ...
  },
  {
    ...
    subtitle: "Organize",
    description:
      "文字起こし・要約・トピック抽出・アクションアイテムまで自動で整理。議事録作成の工数はゼロになります。",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    subtitle: "Answer",
    description:
      "「先週の商談で何を決めた？」過去の全会議・ドキュメントから関連情報を検索し、根拠を示しながら即座に回答します。",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
  ...
  },
  {
    ...
    subtitle: "Accumulate",
    description:
      "個人の記憶に頼らない。蓄積されたナレッジがチーム全体の資産になり、使うほどAIの回答精度も向上します。",
    icon: (
      <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path
          strokeLinecap="round"
    ...
    <>
      ...
      <section className="relative bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1100px] mx-auto px-6 md:px-10 pt-32 pb-24 md:pt-40 md:pb-32 text-center">
          <FadeIn>
            <p className="section-title-en text-sm text-white/40 tracking-[0.2em] mb-6">
              YOUR AI ASSISTANT
            </p>
            ...
            <Link
              ...
              className="pill-btn !border-white/30 !text-white hover:!bg-white hover:!text-black"
            >
      ...
      <section className="py-20 bg-gray-50 overflow-hidden">
        <div className="max-w-[1100px] mx-auto px-6 md:px-10">
          <FadeIn>
            <p className="section-title-en text-sm text-gray-400 tracking-[0.2em] text-center mb-2">
              Integration
            </p>
              ...
              <div className="flex flex-col items-center gap-4">
                <div className="relative">
                  ...
                  <div className="relative w-24 h-24 md:w-28 md:h-28 rounded-2xl overflow-hidden shadow-lg border-2 border-indigo-200">
                    <Image
                      src="/images/ascend-agent-icon.png"
                      alt="Ascend Agent"
                      width={112}
                      height={112}
        ...
        <div className="max-w-[1100px] mx-auto px-6 md:px-10">
          <FadeIn>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-6">
              もし、あなた専属のAIアシスタントがいたら？
            </h2>
            <p className="text-gray-500 text-sm text-center mb-16 max-w-xl mx-auto">
              Ascend Agentがいる働き方は、今までの「当たり前」を変えます。
            </p>
          </FadeIn>
              ...
              <FadeIn key={i} delay={i * 100}>
                <div className="bg-white rounded-xl p-8 md:p-10 hover:shadow-lg transition-shadow h-full">
                  <div className="flex items-center gap-4 mb-5">
                    ...
                    <div>
                      <p className="section-title-en text-xs text-gray-400 tracking-[0.15em]">
                        {a.subtitle}
                      </p>
            ...
            <FadeIn direction="left" className="flex-1 w-full">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-gray-200">
                <Image
                  ...
                  alt="Ascend Agent RAGチャット画面 - AIが議事録を横断検索して回答"
                  width={1440}
                  height={900}
      ...
      <section className="py-24 bg-black text-white overflow-hidden">
        <div className="max-w-[1100px] mx-auto px-6 md:px-10">
          <FadeIn>
            <p className="section-title-en text-sm text-white/40 tracking-[0.2em] text-center mb-2">
              Automated Pipeline
            </p>
            <h2 className="text-2xl md:text-3xl font-bold text-center mb-6">
              完全自動 &#8212; セットアップ後は手間ゼロ
            ...
            {impacts.map((item, i) => (
              <FadeIn key={i} delay={i * 120}>
                <div className="text-center p-8">
                  <p className="section-title-en text-5xl md:text-6xl font-bold text-black mb-3">
                    {item.value}
                  </p>
            ...
            {[
              {
                title: "認証基盤",
                description:
                  "Google OAuth認証を採用。安全なログインと自動的なセッション管理を提供します。",
                icon: (
              ...
              },
              {
                title: "テナント完全隔離",
                description:
                  "全データに組織フィルタを適用。組織間のデータは完全に分離され、相互にアクセスできません。",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              },
              {
                title: "ロール管理",
                description:
                  "管理者・メンバー・ゲストの3段階の権限設定。招待コードで安全にメンバーを追加できます。",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              },
              {
                title: "データ暗号化",
                description:
                  "すべてのデータは暗号化して保存。機密性の高い情報も安全に管理されます。",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              },
              {
                title: "オートスケール",
                description:
                  "利用状況に応じて自動でスケール。急なアクセス増加にも安定したパフォーマンスを維持します。",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              },
              {
                title: "データ保護",
                description:
                  "安全なアクセス制御と通信の暗号化により、データの漏洩リスクを最小限に抑えます。",
                icon: (
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
              ...
              <FadeIn key={i} delay={i * 120}>
                <div className="text-center">
                  <div className="relative inline-flex items-center justify-center w-28 h-28 rounded-full bg-gray-100 mb-6">
                    ...
                    <div className="absolute -top-2 -right-2 w-9 h-9 rounded-full bg-black text-white flex items-center justify-center text-sm font-bold section-title-en">
                      {s.number}
                    </div>
                  </div>
                  <h3 className="text-base font-bold mb-2">{s.title}</h3>
              ...
              <FadeIn key={i} delay={i * 80}>
                <div className="bg-white rounded-lg p-6 hover:shadow-md transition-shadow">
                  <div className="flex items-start gap-4">
                    <span className="flex-shrink-0 w-8 h-8 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center text-sm font-bold section-title-en">
                      Q
                    </span>
                    <div>
      ...
      <section className="relative py-24 bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 max-w-[1100px] mx-auto px-6 md:px-10 text-center">
          <FadeIn>
            <p className="section-title-en text-sm text-white/40 tracking-[0.2em] mb-4">
              Contact Us
            </p>
