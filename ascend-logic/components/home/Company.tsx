      ...
      <div className="relative w-full max-w-[1280px] mx-auto px-8 max-[720px]:px-5">
        <div className="grid grid-cols-[1.2fr_1fr] gap-[60px] items-end mb-16 max-[880px]:grid-cols-1 max-[880px]:gap-6">
          <div>
            ...
            <h2 className="font-bold text-[clamp(28px,3.6vw,48px)] leading-[1.25] tracking-[-0.01em] m-0 mt-4">会社情報</h2>
          </div>
        </div>
        ...
        <div className="grid grid-cols-[1.4fr_1fr] gap-12 items-start max-[880px]:grid-cols-1">
              ...
              {[
                {
                  ...
                  v: (
                    <>
                      株式会社 Ascend Logic
                      <br />
                      <span className="font-mono tracking-[0.02em] text-[13px] text-muted-foreground">Ascend Logic, Inc.</span>
                    </>
                  ),
                },
                { k: '設立', v: '2025年12月' },
                {
                  ...
                  v: (
                    <>
                      早乙女 琉真
                      <span className="font-mono tracking-[0.02em] text-[13px] text-muted-foreground ml-2">CEO</span>
                    </>
                  ),
                },
                {
                ...
                <div key={k} className="grid grid-cols-[200px_1fr] gap-6 py-6 border-b border-border max-[880px]:grid-cols-1 max-[880px]:gap-1.5 max-[880px]:py-4">
                  <dt className="font-mono text-[11px] tracking-[0.12em] uppercase text-muted-foreground pt-[3px]">{k}</dt>
                  <dd className="m-0 text-[15px] leading-[1.7] text-foreground">{v}</dd>
                </div>
              ))}
            </dl>
          </div>
          <div className="flex flex-col gap-4">
            <div className="p-6 border border-border rounded-[18px] bg-surface flex flex-col gap-2">
              <div className="font-mono tracking-[0.02em] text-[13px] text-muted-foreground">FOUNDED</div>
              <div className="font-en font-semibold text-[56px] leading-none tracking-[-0.04em]">2025</div>
              <div className="text-muted-foreground">December · Tokyo</div>
            </div>
            <div className="p-6 border border-border rounded-[18px] bg-surface flex flex-col gap-2">
              <div className="font-mono tracking-[0.02em] text-[13px] text-muted-foreground">FOCUS</div>
              <div className="font-en font-semibold text-[56px] leading-none tracking-[-0.04em]">04</div>
