...
const features = [
  { ic: '01', t: '自動参加 & 録音', d: 'Zoom / Google Meet / Teams / Webex にAIボットが自動参加し、録音・文字起こしまで完了。' },
  { ic: '02', t: '議事録 & アクション抽出', d: '発言ベースの議事録と、決定事項・宿題タスクを自動で構造化。' },
  { ic: '03', t: 'カレンダー連携で完全自動', d: 'Google Calendar から会議を検出し、人手を介さずナレッジ蓄積まで。' },
  { ic: '04', t: 'ナレッジ検索 AIチャット', d: '蓄積された議事録やドキュメントに、自然言語で問い合わせ。' },
        ...
        <div className="agent-head">
          <div>
            ...
            <h2 className="h-section agent-h" style={{ marginTop: 16 }}>
              <span className="en agent-h__en">Ascend Agent</span><br />
              すべての社員に、<br />
              もう一人のAIアシスタントを。
            </h2>
          </div>
