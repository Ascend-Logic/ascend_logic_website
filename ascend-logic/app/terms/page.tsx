  ...
  return (
    <>
      ...
      <section id="privacy-policy" className="py-20 bg-gray-50 border-t border-gray-200">
        <div className="max-w-[900px] mx-auto px-6 md:px-10">
          <FadeIn>
            <h2 className="font-en font-semibold text-sm text-gray-400 tracking-widest mb-2">Privacy Policy</h2>
                  ...
                  <>
                    ...
                    <div className="bg-white p-6 rounded-lg space-y-3 border border-gray-200 text-sm">
                      <div>
                        ...
                        <span className="text-gray-600 ml-2">メールアドレス、氏名、所属組織</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-800">Google アカウント情報:</span>
                        <span className="text-gray-600 ml-2">Google Calendar へのアクセス許可</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-800">会議データ:</span>
                        <span className="text-gray-600 ml-2">会議の録画、文字起こし、議事録</span>
                      </div>
                    </div>
                  </>
                ),
                  ...
                  <>
                    ...
                    <div className="bg-white p-6 rounded-lg space-y-3 border border-gray-200 text-sm">
                      ...
                      <div>
                        ...
                        <span className="text-gray-600 ml-2">会議への参加、録画、文字起こし</span>
                      </div>
                      <div>
                        <span className="font-medium text-gray-800">Google Cloud Platform:</span>
                        <span className="text-gray-600 ml-2">データの保存、AI処理</span>
                      </div>
                    </div>
                  </>
                ),
                ...
                content: (
                  <div className="bg-white p-6 rounded-lg space-y-3 border border-gray-200 text-sm">
                    ...
                    <div>
                      ...
                      <span className="text-gray-600 ml-2">ユーザーが削除するまで無期限</span>
                    </div>
                    <div>
                      <span className="font-medium text-gray-800">暗号化:</span>
                      <span className="text-gray-600 ml-2">保存時および転送時に暗号化されます</span>
                    </div>
                    <div>
