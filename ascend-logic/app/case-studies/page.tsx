  ...
  return (
    <>
      <PageHero
        ...
        titleJa="導入事例"
        description="様々な業種のお客様がどのようにAIで業務改善を実現したかをご覧ください。"
      />
                ...
                <Link href={`/case-studies/${study.id}`} className="block border-r border-b border-gray-200 group">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="bg-white/90 text-gray-800 px-3 py-1 text-xs font-medium rounded">
                        {study.industry}
                      </span>
                    </div>
                  </div>
                  <div className="p-5">
                    <h2 className="text-base font-bold mb-2 group-hover:text-indigo-600 transition-colors line-clamp-2">
                      {study.title}
                    </h2>
                    <p className="text-gray-500 text-xs leading-relaxed line-clamp-3">{study.description}</p>
                    <span className="inline-block mt-3 text-xs text-gray-400 group-hover:text-indigo-600 transition-colors">
                      詳細を見る →
                    </span>
                  </div>
                </Link>
