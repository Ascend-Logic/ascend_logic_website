        ...
        <div className="al-footer__top">
          ...
          <div className="al-footer__nav">
            <div>
              ...
              <ul>
                <li><Link href="/services">オーダーメイドAI開発</Link></li>
                <li><Link href="/services">プロセス自動化</Link></li>
                <li><Link href="/services">データ分析・予測</Link></li>
                <li><Link href="/services">AI導入コンサルティング</Link></li>
              </ul>
            </div>
            <div>
              <div className="mono tiny muted al-footer__h">PRODUCT</div>
              <ul>
                <li><Link href="/products/ascendai">Ascend Agent</Link></li>
                <li><Link href="/products/ascendai">Features</Link></li>
                <li><Link href="/products/ascendai">Security</Link></li>
                <li><Link href="/request-documents">デモ依頼</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul>
                ...
                <li><Link href="/request-documents">お問い合わせ</Link></li>
              </ul>
            </div>
          </div>
        </div>
        <div className="al-footer__bottom">
          <div className="al-footer__mark en" aria-hidden="true">ASCEND LOGIC</div>
          {isAscendAiProduct && (
            <div style={{ paddingTop: 8, paddingBottom: 8, borderTop: '1px solid var(--border)' }}>
              <div className="mono tiny muted" style={{ marginBottom: 8 }}>USING AI SERVICES</div>
              <p className="tiny muted" style={{ margin: 0, lineHeight: 1.7 }}>
                本サービスは以下のAIサービスを利用しています。<br />
