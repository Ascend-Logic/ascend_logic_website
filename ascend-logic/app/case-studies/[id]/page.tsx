  ...
  const caseStudies: DetailedCaseStudy[] = [
    {
      ...
      approach:
        "最新のRAG技術とマルチモーダルAIを組み合わせ、テキストだけでなく図面や画像も理解できる統合検索システムを構築。建築特有の専門用語や図面記号を学習させた独自モデルを開発しました。",
      technologies: [
      ...
      duration: "3ヶ月",
      testimonial:
        "これまで資料探しに費やしていた時間が劇的に削減され、本来の設計業務に集中できるようになりました。新入社員も過去の知見にアクセスしやすくなり、教育効率が大幅に向上しています。",
    ...
    },
    {
      ...
      title: "AI議事録システム",
      description:
        "ZoomやMicrosoft Teamsなどの会議ツールに専用botを導入するだけで、リアルタイムで高精度な議事録を自動生成。話者認識、重要ポイント抽出、タスク管理まで完全自動化。",
      company: "IT企業コンソーシアム",
      industry: "IT・通信",
      solution: "プロセス自動化",
      results: [
      ...
      challenge:
        "毎日多数の会議が行われる中、議事録作成に膨大な時間を費やしていました。また、会議で決定したタスクの抜け漏れや、部門間での情報共有不足が課題となっていました。",
      approach:
      ...
      duration: "3ヶ月",
      testimonial:
        "会議後すぐに議事録が共有され、決定事項が明確になったことで、プロジェクトの進行速度が格段に上がりました。",
    ...
    // },
    {
      ...
      description:
        "数十万件以上の精緻なアノテーションと独自の画像前処理技術により、ブレた写真や部分的な画像からも高い精度で車種判別が可能なAIモデルを開発。",
      company: "大手損害保険会社",
      industry: "保険・金融",
      solution: "データ分析・予測",
      results: [
      ...
      challenge:
        "自動車保険の査定業務において、事故車両の車種特定に時間がかかり、査定の遅延が顧客満足度低下の要因となっていました。",
      approach:
        "独自のデータ拡張技術により、様々な条件下での車両画像を学習。部分的な車体画像からも車種を特定できるよう、パーツ認識と全体推論を組み合わせたアンサンブルモデルを構築しました。",
      technologies: [
        "YOLO v8",
        "Vision Transformer",
        "Data Augmentation",
    ...
    },
    {
      ...
      title: "カウンセリングAI",
      description:
        "精神科医監修のもと、音声分析・表情認識・自然言語処理を統合したパーソナライズドカウンセリングAIアプリを開発。",
      ...
      challenge:
        "メンタルヘルスケアの需要が急増する中、専門カウンセラーの不足により、多くの人が適切なサポートを受けられない状況でした。",
      approach:
        "精神科医・臨床心理士と共同で、エビデンスベースのカウンセリングプロトコルをAIに実装。音声・表情・言語の多角的分析により、人間のカウンセラーに近い共感的な対話を実現しました。",
      technologies: [
      ...
      duration: "6ヶ月",
      testimonial:
        "24時間いつでもアクセスでき、プライバシーも守られる環境で相談できることが、多くのユーザーに支持されています。",
    ...
    },
    {
      ...
      title: "大使館ポータルサイトの開発",
      description:
        "在外公館向けの多言語対応ポータルサイトを構築。AIによる自動翻訳システムと、各種申請手続きの自動化により、領事サービスの効率化と利便性向上を実現。",
      company: "某国大使館",
      industry: "政府・公共機関",
      solution: "プロセス自動化",
      results: [
      ...
      challenge:
        "在外邦人へのサービス提供において、時差や言語の壁、複雑な申請手続きが課題となっていました。",
      approach:
        "AI翻訳と自動フォーム生成技術を活用し、多言語対応のセルフサービスポータルを構築。申請書類の自動チェック機能により、不備による手戻りを最小化しました。",
      technologies: [
      ...
      duration: "1ヶ月",
      testimonial:
        "デジタル化により、在外邦人の方々がいつでもどこからでもサービスを利用できるようになりました。",
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-10">
          <FadeIn>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
              ...
              <span className="inline-block self-start bg-white/10 text-white/80 px-4 py-1.5 rounded text-xs tracking-wider font-medium">
                {caseStudy.industry}
              </span>
            </div>
          </FadeIn>
            ...
            <div className="lg:col-span-2">
              ...
              <FadeIn>
                ...
                <p className="text-gray-600 leading-relaxed mb-12">
                  {caseStudy.challenge ||
                    `${caseStudy.company}様は、業務の非効率性と増大するコストという課題に直面していました。`}
                </p>
              </FadeIn>
              ...
              <FadeIn>
                ...
                <p className="text-gray-600 leading-relaxed mb-12">
                  {caseStudy.approach ||
                    `Ascend Logicは、最新のAI技術を活用した${caseStudy.solution}ソリューションを提案・導入しました。`}
                </p>
              </FadeIn>
            </div>
            ...
            <div className="lg:col-span-1">
              <FadeIn>
                <div className="sticky top-24 bg-gray-50 rounded-lg p-6 space-y-6">
                  <div>
                    <h4 className="text-xs text-gray-400 tracking-wider uppercase mb-2 section-title-en">
                      Solution
                    </h4>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {caseStudy.technologies.map((tech, index) => (
                          <span
                            key={index}
                            className="text-xs bg-white border border-gray-200 px-3 py-1 rounded"
                          >
                            {tech}
                          </span>
                        ))}
